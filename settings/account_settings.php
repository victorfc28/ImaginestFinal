...
<body>
    ...
    <div class="contenedorCard">
        <div class="card">
            ...
            <h2><?php echo IDIOMES['ACCOUNT_SETTINGS']; ?></h2>
            <a href="./user_settings.php"><?php echo IDIOMES['USER_SETTINGS']; ?></a><br>
            <a href="./change_password.php"><?php echo IDIOMES['CHANGEPASSWORD']; ?></a><br>
            <a href="./deactivate_account.php"><?php echo IDIOMES['DEACTIVATEACCOUNT']; ?></a><br>
        </div>    
    </div>
    <!-- Site footer -->
