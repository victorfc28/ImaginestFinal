...
<body>
    ...
    <div class="contenedorCard">
        <div class="card">
            ...
            <h2><?php echo IDIOMES['USER_SETTINGS']; ?></h2>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                <p><strong><?php echo IDIOMES['ALERT']; ?></strong> <?php echo IDIOMES['USER_SETTINGS_ALERT']; ?></p>
                <label for="fname"><?php echo IDIOMES['USER']; ?></label><br>
                <input type="text" id="username" name="username" value="<?php echo $username?>"><br>
                <label for="fname"><?php echo IDIOMES['USERFIRSTNAME']; ?></label><br>
                <input type="text" id="userFirstName" name="userFirstName" value="<?php echo $userFirstName?>"><br>
                <label for="fname"><?php echo IDIOMES['USERLASTNAME']; ?></label><br>
