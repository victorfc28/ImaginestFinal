    ...
    try{
        ...
        if($usuaris){
            ...
            if($count<1){
                ...
                $sql = "INSERT INTO `users` values(:iduser,:mail,:username,:passHash,:userFirstName,:userLastName,:userLanguage,sysdate(),:lastSignIn,:removeDate,:active,:activationDate,:activationCode,:resetPass,:resetPassExpiry,:resetPassCode)";
                ...
                if($insert){
                    ...
                    require_once("./php/registerMailSend.php");
